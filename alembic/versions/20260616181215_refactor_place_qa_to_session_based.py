...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('title', sa.String(length=255), nullable=False, server_default='New Q&A'),
    ...
    op.create_index(op.f('ix_place_qa_sessions_id'), 'place_qa_sessions', ['id'], unique=False)
    op.create_index(op.f('ix_place_qa_sessions_user_id'), 'place_qa_sessions', ['user_id'], unique=False)
    op.create_index(op.f('ix_place_qa_sessions_place_id'), 'place_qa_sessions', ['place_id'], unique=False)
    op.create_index(op.f('ix_place_qa_sessions_last_message_at'), 'place_qa_sessions', ['last_message_at'], unique=False)
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['session_id'], ['place_qa_sessions.id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_place_qa_messages_id'), 'place_qa_messages', ['id'], unique=False)
    op.create_index(op.f('ix_place_qa_messages_session_id'), 'place_qa_messages', ['session_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_place_answer_logs_session_id'), table_name='place_answer_logs')
    op.drop_constraint('fk_place_answer_logs_session_id', 'place_answer_logs', type_='foreignkey')
    ...
    op.drop_constraint('fk_place_questions_session_id', 'place_questions', type_='foreignkey')
    ...
    op.drop_index(op.f('ix_place_qa_messages_session_id'), table_name='place_qa_messages')
    ...
    op.drop_index(op.f('ix_place_qa_sessions_last_message_at'), table_name='place_qa_sessions')
